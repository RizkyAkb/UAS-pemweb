                ...
                <form>
                    <div class="row align-items-end">
                        ...
                        <div class="col-lg-2 mb-lg-3 mt-2">
                            <a href='view/rooms.php' class="btn text-white shadow-none custom-bg">Submit</a>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <div class="container">
        <div class="row justify-content-evenly px-lg-0 px-md-0 px-5 ">
            <div class="col-lg-2 col-md-2 text-center bg-white rounded shadow py-4 my-3">
                <img src="images/facilities/weightlifter.png" width="80px">
            ...
            <div class="col-lg-2 col-md-2 text-center bg-white rounded shadow py-4 my-3">
                <img src="images/facilities/cocktail.png" width="80px">
                <h5 class="mt-3">Cafe & Bar</h5>
            </div>
            <div class="col-lg-2 col-md-2 text-center bg-white rounded shadow py-4 my-3">
                <img src="images/facilities/meeting.png" width="80px">
                <h5 class="mt-3">Meeting Rooms</h5>
            </div>
            <div class="col-lg-12 text-center mt-5">
                <a href="view/facilities.php" class="btn btn-sm btn-outline-dark rounded-0 fw-bold shadow-none">More Facilities >>></a>
            </div>
        </div>
    </div>
