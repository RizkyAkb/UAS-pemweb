                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="cancelled_booking.php" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                    ...
                                    <div class="card-body table-responsive p-2" style="height: 600px;">
                                        ...
                                        <table id="tabel-data" class="table table-bordered table-head-fixed text-nowrap">
                                            ...
                                            <tbody>
                                                <?php
                                                $no = 1;
                                                $result = mysqli_query($conn, "SELECT * FROM booking_room br LEFT JOIN room r ON br.room_id = r.room_id LEFT JOIN user_data ud ON br.user_id = ud.user_id WHERE br.status ='Request cancel'");
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><a class='btn btn-info btn-sm btx inf' href='model/cancel_book.php?booking_id=<?= $item['booking_id'] ?>'>
