                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="check_in.php" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Check In</p>
                                    </a>
                                </li>
                                    ...
                                    <div class="card-body table-responsive p-2" style="height: 600px;">
                                        ...
                                        <table id="tabel-data"
                                            ...
                                            <tbody>
                                                <?php
                                                $no = 1;
                                                $result = mysqli_query($conn, "SELECT * FROM booking_room br LEFT JOIN room r ON br.room_id = r.room_id LEFT JOIN user_data ud ON br.user_id = ud.user_id WHERE br.status ='Check-in'");
                                                while ($item = mysqli_fetch_array($result)) {
                                                    $booking_id = $item['booking_id'];
                                                    if (strtotime($item['check_out']) < strtotime(date('Y-m-d'))) {
                                                        $update = mysqli_query($conn, "UPDATE booking_room SET status='Success' WHERE booking_id=$booking_id");
                                                    }
                                                ?>
                                                <tr>
                                                    ...
                                                    <td><a class='btn btn-info btn-sm btx inf'
                                                            href='model/check_in.php?booking_id=<?= $item['booking_id'] ?>'>
