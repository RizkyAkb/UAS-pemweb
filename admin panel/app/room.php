            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="d-flex flex-row justify-content-between mb-3">
                        <h1>Room</h1>
                        <button role="submit" name="multiple_blog_delete" class="btn btn-danger delSelect">Delete
                            Selection Room</button>
                        <a href="add_room.php" role="button" class="btn btn-success createx">Add Room</a>
                    </div>
                </div><!-- /.container-fluid -->
            </section>
                                ...
                                <div class="card-body table-responsive p-2" style="height: 600px;">
                                    ...
                                    <table id="" class="table table-bordered table-head-fixed text-nowrap">
                                        ...
                                        <tbody>
                                            <?php
                                                $no = 1;
                                                $result = mysqli_query($conn, "SELECT * FROM room ORDER BY room_id ASC");
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $item['feature'] ?></td>
                                                <td>
                                                    <a class='btn btn-info btn-sm btx inf'
                                                        href='edit_room.php?room_id=<?= $item['room_id'] ?>'>
                                                        <i class='fas fa-pencil-alt'>
                                                        </i>
                                                        Edit
                                                    </a>
                                                    <a class='btn btn-danger btn-sm btx dan'
                                                        href='model/delete_room.php?room_id=<?= $item['room_id'] ?>'>
